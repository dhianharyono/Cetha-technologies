    ...
    <section id='why-us' className='py-16 md:py-24 relative z-10 p-4'>
      ...
      <div className='container mx-auto px-4 md:px-6'>
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className='text-xl md:text-4xl font-extrabold text-white mb-2 md:mb-4'>
            Mengapa Anda{' '}
          ...
          <p className='text-sm md:text-lg text-slate-400'>
            Di era digital, sekadar eksis di media sosial seringkali tidak
            cukup. Media sosial seperti menyewa ruko, sedangkan website adalah
            rumah Anda sendiri.
          </p>
        </motion.div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-12 gap-4 lg:gap-6 max-w-5xl mx-auto'>
          {reasons.map((reason, index) => {
            ...
            if (index === 0)
              colSpan = 'md:col-span-8'; // Sangat lebar
            else if (index === 1)
              colSpan = 'md:col-span-4'; // Kotak kecil
            else if (index === 2)
              colSpan = 'md:col-span-5'; // Kotak kecil
