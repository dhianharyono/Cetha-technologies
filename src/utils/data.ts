export const projects = [
  {
    ...
    fitur: ['Keranjang Belanja', 'Payment Gateway', 'Dashboard Penjualan'],
    paket: 'Enterprise',
  },
  {
    ...
    fitur: ['Kategori Berita', 'Optimasi SEO', 'CMS Admin'],
    paket: 'Pro Business',
  },
  {
    ...
    fitur: ['Profil Perusahaan', 'Katalog Layanan', 'Formulir Kontak'],
    paket: 'Pro Business',
  },
];
